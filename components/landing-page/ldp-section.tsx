...
export default function LDPSection() {
  return (
    <section id="ldp" className="relative py-24 md:px-12 my-auto ">
      {/* Background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 z-10">
        <div className="flex flex-col lg:flex-row gap-x-20 gap-y-10">
          ...
          <div className="min-w-[120px]">
            <h2 className="text-[14px] font-bold uppercase tracking-[0.2em] leading-tight text-white text-shadow-lg">
          ...
          <div className="space-y-12">
            <h1 className="text-white text-[30px] md:text-[36px] font-bold leading-tight text-shadow-2xs">
            ...
            <p className="text-white">
              ...
              build the clarity, confidence, and influence to lead yourself and
              others with purpose, creating growth that goes beyond your career
              and lasts beyond you.
            </p>
