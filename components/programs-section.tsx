import { Clock, Users, Target, ArrowRight, Briefcase, Award, Zap, BookOpen } from "lucide-react"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programs.map((program, index) => {
            ...
            return (
              <div
                key={index}
                className="card-depth group p-6 bg-gradient-to-br from-muted to-white rounded-xl border border-border hover:border-accent/50 transition-all"
              >
                {/* Header */}
                ...
                <div className="space-y-2 mb-6 pb-6 border-b">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-muted-foreground text-xs ml-auto">{program.format}</span>
                  </div>
                </div>
