import { CheckCircle2, User, Target, Briefcase, Zap, Award } from "lucide-react"

const timelineSteps = [
  {
    step: 1,
    title: "Register & Consultation",
    description: "Sign up and meet with our career advisors to understand your goals",
    icon: User,
  ...
  },
  {
    step: 2,
    title: "Assessment",
    description: "Comprehensive evaluation of your skills, interests, and potential",
    icon: Target,
...
export function TimelineSection() {
  return (
    <section id="journey" className="py-20 px-4 bg-gradient-to-b from-white to-muted">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">Your Journey</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Follow our proven pathway to career acceleration and corporate success
          </p>
        </div>
            ...
            {timelineSteps.map((item, index) => {
              ...
              return (
                <div key={index} className="relative">
                  ...
                  {/* Content */}
                  <div className={`md:w-1/2 ${isEven ? "md:mr-auto md:pr-12" : "md:ml-auto md:pl-12"}`}>
